...
import random  # Useful to have for hash gen and picking an item randomly from a list
...
def print_logo_to_screen():
	...
	print(f'{terminal_colours.FAIL}{terminal_colours.BOLD}{DASHES}{terminal_colours.ENDC}')
	print(f'{terminal_colours.CYAN}{terminal_colours.BOLD}{random.choice(sub_text)}{terminal_colours.ENDC}\n\n\n')
